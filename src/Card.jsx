...
const Card = (props) => {
  ...
  const like = (postId) => {
    ...
    axios
      .put("/api/user/like", { postId }, config)
      .then((response) => {
  ...
  const unlike = (postId) => {
    ...
    axios
      .put("/api/user/unlike", { postId }, config)
      .then((response) => {
        if (response.data.success) {
          setLikes(response.data.result.likes.length);
        } else {
        ...
        <div className="card w-100">
          <div className="card-body" id="card-style">
            ...
            <div class="timeline-header">
              ...
              <div>
                <span class="username">
                  <a href="#" style={{ fontFamily: "cursive" }}>
                    <svg
